...
[![Build Status](https://img.shields.io/travis/mozilla/oneanddone/master.svg)](https://travis-ci.org/mozilla/oneanddone)

[![Coverage status](https://img.shields.io/coveralls/mozilla/oneanddone/master.svg)](https://coveralls.io/r/mozilla/oneanddone)

Run the tests
-------------

There's a sample test in `oneanddone/base/tests.py` for your convenience, that
...
3. Run the image:
    ...
    docker run --env-file env -p 80:80 mozilla/oneanddone
